...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-black">
    ...
    <!-- Manage Users Button (Visible to Admin Only) -->
    @auth
    @if(Auth::user()->role === 'admin')
        <a href="{{ route('users.index') }}" class="inline-block mb-6 px-6 py-3 bg-[#4EB57C] text-white rounded-lg hover:bg-[#357a5c] transition">
            Manage Users
        </a>
    @endif
    @endauth
